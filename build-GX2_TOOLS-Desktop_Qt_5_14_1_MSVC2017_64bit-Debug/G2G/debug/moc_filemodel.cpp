...
#include <memory>
#include "../../../GERBER_X2-0304/G2G/filetree/filemodel.h"
...
QT_MOC_LITERAL(1, 10, 13), // "updateActions"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 6), // "select"
QT_MOC_LITERAL(4, 32, 11) // "QModelIndex"

    },
    "FileModel\0updateActions\0\0select\0"
    "QModelIndex"
};
...
void FileModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->select((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FileModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileModel::updateActions)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FileModel::*)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileModel::select)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FileModel::updateActions()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void FileModel::select(const QModelIndex & _t1)
{
