...
#include <memory>
#include "../../../GERBER_X2-0304/graphicsview/graphicsview.h"
...
QT_MOC_LITERAL(1, 13, 10), // "fileDroped"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 9), // "mouseMove"
QT_MOC_LITERAL(4, 35, 5) // "scale"

    },
    "GraphicsView\0fileDroped\0\0mouseMove\0"
    "scale"
};
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->fileDroped((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->mouseMove((*reinterpret_cast< const QPointF(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::fileDroped)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GraphicsView::*)(const QPointF & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::mouseMove)) {
                *result = 1;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< double*>(_v) = _t->getScale(); break;
        default: break;
        }
...
// SIGNAL 0
void GraphicsView::fileDroped(const QString & _t1)
{
...
// SIGNAL 1
void GraphicsView::mouseMove(const QPointF & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
