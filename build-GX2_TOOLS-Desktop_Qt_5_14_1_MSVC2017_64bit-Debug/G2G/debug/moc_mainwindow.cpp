...
#include <memory>
#include "../../../GERBER_X2-0304/G2G/mainwindow.h"
...
QT_MOC_LITERAL(1, 11, 15), // "parseGerberFile"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 8), // "filename"
QT_MOC_LITERAL(4, 37, 17) // "parseExcellonFile"

    },
    "MainWindow\0parseGerberFile\0\0filename\0"
    "parseExcellonFile"
};
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->parseGerberFile((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->parseExcellonFile((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindow::parseGerberFile)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainWindow::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindow::parseExcellonFile)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MainWindow::parseGerberFile(const QString & _t1)
{
...
// SIGNAL 1
void MainWindow::parseExcellonFile(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
